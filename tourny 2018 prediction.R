...
games_2018 <- read.csv("NCAA Tournament Games plus 2018.csv",stringsAsFactors = FALSE, strip.white = TRUE)
...
write.csv(analyze.2018, file = "analyze2021withInj.csv")
